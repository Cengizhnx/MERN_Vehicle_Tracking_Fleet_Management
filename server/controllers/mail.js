...
export const sendMail = async (req, res, next) => {
  const { email, name, route, car, driver, type } = req.body;
  ...
  try {
    ...
    } else if (type === "addFleet") {
      const subject = "🏢 Filo Oluşturuldu.";
      const message = fleetTemplate(email, name, route);
      await sendEmail(subject, message, send_to, sent_from, reply_to);
      res.status(200).json({ success: true, message: "Email Gönderildi" });
    }
  } catch (error) {
...
const fleetTemplate = (email, name, route, car, driver) => {
  return `<!DOCTYPE html>
  <html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="tr-TR">
                      ...
                      <tbody>
                        <tr>
                          <td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-right: 25px; padding-top: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                            ...
                            <table class="text_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                              <tr>
                                <td class="pad" style="padding-left:10px;padding-right:10px;">
                                  <div style="font-family: sans-serif">
                                    <div class style="font-size: 12px; font-family: 'Catamaran', 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
                                      <p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 14.399999999999999px;"><span style="font-size:38px;">Merhaba <strong><span style>${name}</span></strong> 👋</span></p>
                                      <p style="margin: 0; font-size: 12px; mso-line-height-alt: 14.399999999999999px;">&nbsp;</p>
                                    </div>
                                  </div>
                                </td>
                            ...
                            <div class="spacer_block block-3" style="height:185px;line-height:185px;font-size:1px;">&#8202;</div>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                            ...
                            <table class="text_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                              <tr>
                                <td class="pad" style="padding-bottom:10px;padding-left:10px;padding-right:30px;padding-top:10px;">
                                  <div style="font-family: sans-serif">
                                    <div class style="font-size: 12px; font-family: 'Catamaran', 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                      <p style="margin: 0; font-size: 14px; text-align: right; mso-line-height-alt: 21px;"><strong>Pick-up </strong></p>
                                      <p style="margin: 0; font-size: 14px; text-align: right; mso-line-height-alt: 21px;"><strong>lorem ipsum</strong></p>
                                    </div>
                                  </div>
                                </td>
                              </tr>
                                  ...
                                  <div style="font-family: sans-serif">
                                    <div class style="font-size: 12px; font-family: 'Oswald', 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
                                      <p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 16.8px;"><span style="font-size:26px;"><strong>${
                                        route.fleetName
                                      } </strong>isimli filonuz oluşturuldu<strong> 🏢</strong></span></p>
                                    </div>
                                  </div>
                                </td>
                              </tr>
                              ...
                              <tr>
                                <td class="pad" style="padding-left:10px;padding-right:10px;padding-top:10px;">
                                  <div style="font-family: sans-serif">
                                    <div class style="font-size: 12px; font-family: 'Catamaran', 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
                                      <ul style="line-height: 1.2; mso-line-height-alt: 14.399999999999999px; font-size: 16px;">
                                        <li><span style="font-size:16px;">Filo Adresi :<strong> ${
                                          route.fleetAddress
                                        }&nbsp;</strong></span><br><br></li>
                                        ${route.fleetCars.map(
                                          (item) =>
                            ...
                            <table class="text_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                              <tr>
                                <td class="pad" style="padding-bottom:10px;padding-left:35px;padding-right:10px;padding-top:10px;">
                                  <div style="font-family: sans-serif">
                                    <div class style="font-size: 12px; font-family: 'Catamaran', 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                      <p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 18px;"><span style="font-size:12px;color:#999999;"><em>*Bu bir otomatik mesajdır. Filo oluşturulunca gönderilir.</em></span></p>
                                    </div>
                                  </div>
                                </td>
                              </tr>
